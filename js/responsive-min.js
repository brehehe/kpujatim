...
(function ($, window, undefined) {
    ...
    var defaults = {
        ...
        classes: {
            ...
            stateDefaultNews: 'r-tabs-state-default-News',
            stateDefaultBorder: 'r-tabs-state-default-border',
            stateActive: 'r-tabs-state-active',
            stateDisabled: 'r-tabs-state-disabled',
            stateExcluded: 'r-tabs-state-excluded',
            tab: 'r-tabs-tab',
            anchor: 'r-tabs-anchor',
            anchorNews: 'r-tabs-anchor-News',
            panel: '',
            panelNews: 'r-tabs-panel-News',
            panelStandard: 'r-tabs-panel',
    ...
    function ResponsiveTabs(element, options) {
        ...
        switch ($ElementID) {
            case "horizontalTabsNewsOne":
                this.options.classes.panel = this.options.classes.panelNews;
                this.options.classes.stateDefault = this.options.classes.stateDefaultNews;
                this.options.classes.anchor = this.options.classes.anchorNews;
                break;
            case "horizontalTabsNewsTwo":
                this.options.classes.panel = this.options.classes.panelNews;
                this.options.classes.stateDefault = this.options.classes.stateDefaultNews;
                this.options.classes.anchor = this.options.classes.anchorNews;
                break;
            default:
                // this.options.classes.stateDefault = this.options.classes.stateDefault;
                this.options.classes.panel = this.options.classes.panelStandard;
                break;
        }
        this.init();
    }
    ...
    ResponsiveTabs.prototype._loadClasses = function () {
        for (var i = 0; i < this.tabs.length; i++) {
            ...
            if (this.tabs[i].disabled) {
                /**
                 if (i === 0) {
                 this.tabs[0].tab.removeClass(this.options.classes.stateDefaultBorder);
                 this.tabs[1].tab.removeClass(this.options.classes.stateDefaultBorder);
                 this.tabs[2].tab.addClass(this.options.classes.stateDefaultBorder);
                 }
                 if (i === 1) {
                 ...
                 if (i === 2) {
                 this.tabs[0].tab.removeClass(this.options.classes.stateDefaultBorder);
                 this.tabs[1].tab.addClass(this.options.classes.stateDefaultBorder);
                 this.tabs[2].tab.removeClass(this.options.classes.stateDefaultBorder);
                 }
                 **/
    ...
    ResponsiveTabs.prototype._openTab = function (e, oTab, closeCurrent, stopRotation) {
        ...
        // sesudah aktif baru dicek
        $ElementID = this.element.id;
        $yangaktif = this._getCurrentTabRef();
        switch ($ElementID) {
            case "horizontalTabsNewsOne":
                jQuery("#" + this.options.buttonright).attr("href", this.options.linked[$yangaktif]);
                break;
            case "horizontalTabsNewsTwo":
                jQuery("#" + this.options.buttonright).attr("href", this.options.linked[$yangaktif]);
                break;
